  ...
  <div class="h-full">
    ...
    <div
      ...
      <div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
        <form>
          {/* <!--Sign in section--> */}
          <h1 className='py-4 texxxt-3xl pb-6'>Login</h1>
          <div
          ...
          <div class="text-center lg:text-left">
            <button className=' px-7 px-3 bg-blue-600 text-white rounded-md'>Login</button>
            ...
            <p class="mb-0 mt-2 pt-1 text-sm font-semibold">
              ...
              <Link
                to="/register"
                class="text-red-600 transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700">Register</Link>
            </p>
          </div>
        </form>
      </div>
